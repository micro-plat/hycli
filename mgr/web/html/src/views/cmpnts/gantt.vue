<template>
    <div class="gantt">
        <div v-if="header" class="gantt-header">
        ...
        <div v-if="!header" class="gantt-container" >
...
export default {
    ...
    methods: {
        ...
        loadHeaderNo() {
            let that = this
            let range = this.$theia.xdate.formatRange(this.getDateRange(), "ddW")
            range.forEach((v, i) => {
                v.left = i * 20 + 'px'
            })
            this.headerNo = range
